...
NCharacter = {
	...
	AGE_OF_ADULTHOOD_MALE = 14,						-- Male can rule at this age. 
	AGE_OF_ADULTHOOD_FEMALE = 14,					-- Female can rule at this age.
	AGE_OF_MARRIAGE_MALE = 12,						-- Male allowed to marry at this age.
	AGE_OF_MARRIAGE_FEMALE = 12,					-- Female allowed to marry at this age.
